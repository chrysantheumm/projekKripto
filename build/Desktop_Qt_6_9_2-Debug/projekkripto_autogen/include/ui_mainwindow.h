...
public:
    ...
    QLineEdit *lineEditInputTextSuper;
    QLineEdit *lineEditShiftSuper;
    QLineEdit *lineEditInputSuper2;
    QLineEdit *lineEditInputSuper3;
    QPushButton *pushButtonEncryptSuper;
    QPushButton *pushButtonDecryptSuper;
    QLineEdit *lineOutputSuper;
    QWidget *pageCaesar;
    ...
    QLabel *label_10;
    QPushButton *pushButtonDecryptCaesar;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButtonBackSuper->setGeometry(QRect(310, 450, 94, 26));
        lineEditInputTextSuper = new QLineEdit(pageSuper);
        lineEditInputTextSuper->setObjectName("lineEditInputTextSuper");
        lineEditInputTextSuper->setGeometry(QRect(220, 130, 300, 30));
        lineEditShiftSuper = new QLineEdit(pageSuper);
        lineEditShiftSuper->setObjectName("lineEditShiftSuper");
        lineEditShiftSuper->setGeometry(QRect(220, 180, 300, 30));
        lineEditInputSuper2 = new QLineEdit(pageSuper);
        lineEditInputSuper2->setObjectName("lineEditInputSuper2");
        lineEditInputSuper2->setGeometry(QRect(220, 230, 300, 30));
        lineEditInputSuper3 = new QLineEdit(pageSuper);
        lineEditInputSuper3->setObjectName("lineEditInputSuper3");
        lineEditInputSuper3->setGeometry(QRect(220, 280, 300, 30));
        pushButtonEncryptSuper = new QPushButton(pageSuper);
        pushButtonEncryptSuper->setObjectName("pushButtonEncryptSuper");
        pushButtonEncryptSuper->setGeometry(QRect(240, 340, 94, 26));
        pushButtonDecryptSuper = new QPushButton(pageSuper);
        pushButtonDecryptSuper->setObjectName("pushButtonDecryptSuper");
        pushButtonDecryptSuper->setGeometry(QRect(400, 340, 94, 26));
        lineOutputSuper = new QLineEdit(pageSuper);
        lineOutputSuper->setObjectName("lineOutputSuper");
        lineOutputSuper->setGeometry(QRect(190, 390, 371, 41));
        ...
        pushButtonEncrypt->setGeometry(QRect(80, 210, 300, 40));
        ...
        pushButtonDecryptCaesar = new QPushButton(pageCaesar);
        pushButtonDecryptCaesar->setObjectName("pushButtonDecryptCaesar");
        pushButtonDecryptCaesar->setGeometry(QRect(420, 210, 300, 40));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        lineEditInputXor2->setPlaceholderText(QCoreApplication::translate("MainWindow", "Masukkan Kunci", nullptr));
        ...
        lineEditInputTextSuper->setPlaceholderText(QCoreApplication::translate("MainWindow", "Masukkan teks", nullptr));
        lineEditShiftSuper->setPlaceholderText(QCoreApplication::translate("MainWindow", "Masukkan shift (angka)", nullptr));
        lineEditInputSuper2->setText(QString());
        lineEditInputSuper2->setPlaceholderText(QCoreApplication::translate("MainWindow", "Masukkan Enkripsi Viginere", nullptr));
        lineEditInputSuper3->setText(QString());
        lineEditInputSuper3->setPlaceholderText(QCoreApplication::translate("MainWindow", "Masukkan Enkripsi XOR", nullptr));
        pushButtonEncryptSuper->setText(QCoreApplication::translate("MainWindow", "Encrypt", nullptr));
        pushButtonDecryptSuper->setText(QCoreApplication::translate("MainWindow", "Decrypt", nullptr));
        lineOutputSuper->setPlaceholderText(QCoreApplication::translate("MainWindow", "  Hasil Akan Tampil Disini", nullptr));
        ...
        pushButtonDecryptCaesar->setText(QCoreApplication::translate("MainWindow", "Decrypt", nullptr));
